...
2.2 Branch-typer
-- Feature -- branches brukes når man lager ny funksjonalitet, for eksempel feature/registreringsskjema.
-- Bugfix -- branches brukes for å rette feil, for eksempel bugfix/fiks-validering.
-- Docs -- branches brukes for dokumentasjon, for eksempel docs/oppdater-readme.
-- Research -- branches brukes til eksperimentering og prototyper, for eksempel research/test-av-layout.
...
3.5 Pull Request
Opprett en Pull Request fra din branch til main. Beskriv hva som er gjort, hvordan det testes, og hvilken Scrumwise-oppgave det gjelder. En annen person skal alltid godkjenne PR-en før den merges. Dette sikrer kvalitet og reduserer risiko for feil.
...
├─ /assets
│  ├─ /css
│  │  ├─ base.css                ← Grunnleggende styling (reset, typografi)
│  │  ├─ layout.css              ← Oppsett av sider, seksjoner og grids
│  │  └─ components.css          ← Knappestiler, kort, tabeller osv.
│  │
│  ├─ /js
│  │  ├─ main.js                 ← Oppstart av applikasjonen
│  │  ├─ api.js                  ← Håndtering av API-kall eller datainnhenting
│  │  ├─ calculator.js           ← Funksjoner knyttet til kalkulator eller logikk
│  │  ├─ ui.js                   ← Funksjoner som oppdaterer HTML-elementer
│  │  └─ helpers.js              ← Gjenbrukbare hjelpefunksjoner
│  │
│  ├─ /img                      ← Bilder og grafikk
│  └─ /components               ← Gjenbrukbare HTML-komponenter (valgfritt)
│     ├─ header.html
│     ├─ footer.html
│     └─ card.html
│
